...
class BullhornAPI:
    ...
    def fetch_all_pages(self, entity, fields, where_clause=None, max_records=None):
        ...
        while True:
            ...
            # Check if we have all records or hit our limit
    ...
    def format_placement_data(self, placements, placement_type):
        ...
        for placement in placements:
            ...
            # Determine primary employee (prefer sales, fallback to recruiter)
            ...
            formatted_placement = {
                ...
                'status': 'Permanent',
                'gp': flat_fee,
                'hourly_gp': 0,  # Not applicable for permanent placements
    ...
    def format_contract_time_data(self, contract_time_records):
        ...
        for record in contract_time_records:
            ...
            # Get employee info from placement
        ...
        for group_key, group in contract_groups.items():
            ...
            formatted_record = {
                ...
                'commission': round(commission, 2),
                'month': group['month'],
                'day': 1,  # Use 1st of month for aggregated data
